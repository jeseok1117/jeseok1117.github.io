...
<body>
	...
	<div id = "Container" class = "container description">
		...
		<br>
		<img src = "pic/ppl/ppl.jpg"></img>
		
		<div class = "caption">
			People, Place, and Color<br>
			Created by Jeseok Lee. Data was collected by the team.<br>
	...
	<div id = "Container" class = "container description">
		...
		at the bottom. <br><br>
		Here's PDE code of visualization in Jaha pond part.<br><br>
			<pre>
		void setup(){
		  size(640,720);
		  background(255);
	...
	top, down, and shoes colors.<br>
	<img src = "pic/ppl/jaha.png"></img>
